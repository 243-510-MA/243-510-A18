...
/*********************************************************************
* Function:         CaronSendTemp
*
* PreCondition:     tayeule
*
* Input:            your penis
*
* Output:           poop. tee-hee
*
* Side Effects:	    drugs are bad, m'kay ?
*
* Overview:         Caron qui essai de faire sa fonction ben simplistique de
*                   lecture de temperature et l'envoi de temperature
*
* Note:			    
**********************************************************************/
